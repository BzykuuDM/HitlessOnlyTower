    ...
    void Update ()
    {
        ...
        if(onGround)
        {
            if(Input.GetButtonDown("Jump"))
            {
                ...
                m_animator.SetFloat("jumpPressure", jumpPressure + minJump);
            }
            else
            {
                if(jumpPressure > 0f)
                {
                    ...
                    m_body2d.velocity = new Vector3(jumpPressure/10f,jumpPressure,0f);
                    jumpPressure = 0f;
                    onGround = false;
                    m_animator.SetFloat("jumpPressure",0f);
